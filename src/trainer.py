...
from models import CNNMnist, CNNFashion_Mnist
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--data-name", type=str, default="mnist", choices=['mnist','cifar10', 'cifar100'], help="dir path for MNIST dataset"
    )
